...
public class Piece
{
    ...
    public void playerInput()
    {
        ...
        pieceList.setFocus(this).fipDirectionAction();
...
public class Reverse : MonoBehaviour
{
    ...
    [SerializeField]
    private TMP_Text redCounterText;
    [SerializeField]
    private TMP_Text blueCunterText;
    ...
    private void Update()
    {
        ...
        if(counter.Blue + counter.Red == size * size)
        {
        ...
        redCounterText.text = $"{(counter.Red < 10 ? '0' : "" )}{counter.Red}";
        redCounterText.text = $"{(counter.Blue < 10 ? '0' : "" )}{counter.Blue}";
    }
}
